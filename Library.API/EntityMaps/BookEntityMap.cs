      ...
      public void Configure(EntityTypeBuilder<Book> builder)
        {
            ...
            builder.Property(_ => _.Author).HasColumnType("nvarchar").HasMaxLength(50).IsRequired();
            builder.Property(_ => _.Genre).HasColumnType("nvarchar").HasMaxLength(50).IsRequired();
